...
export default function LoginPage() {
  ...
  const handleOAuthLogin = (provider: string) => {
    alert(`Initiating sign-in with ${provider}...`);
  };
        ...
        <div className="p-8 bg-[rgba(18,46,39,0.8)] border border-white/5 shadow-[0_0_50px_rgba(24,184,138,0.15)] rounded-[24px] backdrop-blur-[24px]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-xs text-[#C6D6D1] font-semibold leading-relaxed max-w-[280px] mx-auto">
              Sign in to access your subscriptions, API keys, and orders.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs font-semibold text-[#D4AF37] hover:text-[#B8860B] transition-colors duration-200"
                >
                  Forgot Password?
                </Link>
              </div>
